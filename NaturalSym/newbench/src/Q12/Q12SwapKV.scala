...
object Q12SwapKV extends SparkProgramTemplate {
  ...
  override def execute(input1: RDD[String], input2: RDD[String], input3: RDD[String]): RDD[_] = {
    ...
    val map3 = join2.map {
        ...
        // case (_, ((ws_row, i_row), dd_row)) =>
          ...
          ((i_item_id, i_class, i_category, i_item_desc, i_current_price), ws_ext_sales_price) // there should be another value here
          //Q12SwapKV: i_item_desc <-> i_class
      }
