...
object Q6WrongPredicate2 extends SparkProgramTemplate {
  ...
  override def execute(input1: RDD[String], input2: RDD[String], input3: RDD[String], input4: RDD[String], input5: RDD[String]): RDD[_] = {
    ...
    val filter1 = date_dim.filter { row => row.split(",")(6).equals("1") && !row.split(",")(8).equals("2001") } // Q6WrongPredicate2: no !
