...
(assert  (and (<=  x5 1500 )  (and (=  input1_P1_d2  "new car"  )  (and (isinteger  input1_P1_d1 )  (and (=  input1_P2_d2  "new car"  )  (and (isinteger  input1_P2_d1 )  (and (=  x3_P2 x3_P1 )  (and (>  x5 x6 )  (and (=  ( select  x10 1 ) x6 )  (and (>=  1 0 )  (and (<  1 x8 )  (and (=  ( select  x10 0 ) x5 )  (and (>=  0 0 )  (and (<  0 x8 ) (>=  x8 0 ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
