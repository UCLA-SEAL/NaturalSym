...
(assert  (and (=  x4_P1 ( select  x10 0 ) )  (and (=  x4_P2 ( select  x10 1 ) )  (and (=  x3_P1 input1_P1_d3 )  (and (=  x4_P1 ( str.to_int input1_P1_d1  ) )  (and (=  x3_P2 input1_P2_d3 )  (and (=  x4_P2 ( str.to_int input1_P2_d1  ) ) (=  x15 ( str.++ ( str.++ ( str.++  ""  x3_P1 )  ":"  ) ( str.from_int x6  ) ) ) ) ) ) ) ) ) )
(assert  (and (=  input1_P1_d2  "new car"  )  (and (isinteger  input1_P1_d1 )  (and (=  input1_P2_d2  "new car"  )  (and (isinteger  input1_P2_d1 )  (and (=  x3_P2 x3_P1 )  (and (<=  x5 x6 )  (and (=  ( select  x10 1 ) x6 )  (and (>=  1 0 )  (and (<  1 x8 )  (and (=  ( select  x10 0 ) x5 )  (and (>=  0 0 )  (and (<  0 x8 )  (and (>=  x8 0 ) (>  x6 1500 ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
