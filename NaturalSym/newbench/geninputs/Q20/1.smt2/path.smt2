...
(declare-fun x74_P2 () Int)
(declare-fun x58_P1 () String)
...
(declare-fun x74_P1 () Int)
(declare-fun input1_P1_d15 () String)
(declare-fun x35 () (Array Int Int))
...
(assert  (and (=  x29_P1 ( select  x35 0 ) )  (and (=  x29_P2 ( select  x35 1 ) )  (and (=  x1_P1 input1_P1_d2 )  (and (=  x6_P1 input3_P1_d0 )  (and (=  x9_P1 input1_P1_d33 )  (and (=  x16_P1 input2_P1_d0 )  (and (=  x24_P1 input3_P1_d1 )  (and (=  x25_P1 input3_P1_d4 )  (and (=  x26_P1 input3_P1_d12 )  (and (=  x27_P1 input3_P1_d10 )  (and (=  x28_P1 input3_P1_d5 )  (and (=  x29_P1 ( str.to_int input1_P1_d22  ) )  (and (=  x1_P2 input1_P2_d2 )  (and (=  x6_P2 input3_P2_d0 )  (and (=  x9_P2 input1_P2_d33 )  (and (=  x16_P2 input2_P2_d0 )  (and (=  x24_P2 input3_P2_d1 )  (and (=  x25_P2 input3_P2_d4 )  (and (=  x26_P2 input3_P2_d12 )  (and (=  x27_P2 input3_P2_d10 )  (and (=  x28_P2 input3_P2_d5 )  (and (=  x29_P2 ( str.to_int input1_P2_d22  ) )  (and (=  x34 (+  x31 x33 ) )  (and (=  x74_P1 ( select  x80 0 ) )  (and (=  x74_P2 ( select  x80 1 ) )  (and (=  x50_P1 input1_P1_d2 )  (and (=  x55_P1 input3_P1_d0 )  (and (=  x58_P1 input1_P1_d33 )  (and (=  x65_P1 input2_P1_d0 )  (and (=  x73_P1 input3_P1_d10 )  (and (=  x74_P1 ( str.to_int input1_P1_d22  ) )  (and (=  x50_P2 input1_P2_d2 )  (and (=  x55_P2 input3_P2_d0 )  (and (=  x58_P2 input1_P2_d33 )  (and (=  x65_P2 input2_P2_d0 )  (and (=  x73_P2 input3_P2_d10 )  (and (=  x74_P2 ( str.to_int input1_P2_d22  ) ) (=  x79 (+  x76 x78 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(assert  (and (=  input3_P1_d12  "Shoes"  )  (and  (not (=  input3_P1_d12  "Electronics"  ))  (and  (not (=  input3_P1_d12  "Home"  ))  (and (=  x1_P1 x6_P1 )  (and (=  ( str.substr input2_P1_d2  0 (- 7 0) )  "1998-01"  )  (and (=  x9_P1 x16_P1 )  (and (isinteger  input1_P1_d22 )  (and (=  input3_P2_d12  "Shoes"  )  (and  (not (=  input3_P2_d12  "Electronics"  ))  (and  (not (=  input3_P2_d12  "Home"  ))  (and (=  x1_P2 x6_P2 )  (and (=  ( str.substr input2_P2_d2  0 (- 7 0) )  "1998-01"  )  (and (=  x9_P2 x16_P2 )  (and (isinteger  input1_P2_d22 )  (and (=  x24_P2 x24_P1 )  (and (=  x25_P2 x25_P1 )  (and (=  x26_P2 x26_P1 )  (and (=  x27_P2 x27_P1 )  (and (=  x28_P2 x28_P1 )  (and (=  ( select  x35 1 ) x31 )  (and (>=  1 0 )  (and (<  1 x32 )  (and (=  ( select  x35 0 ) x33 )  (and (>=  0 0 )  (and (<  0 x32 )  (and (>=  x32 0 )  (and (=  input3_P1_d12  "Shoes"  )  (and  (not (=  input3_P1_d12  "Electronics"  ))  (and  (not (=  input3_P1_d12  "Home"  ))  (and (=  x50_P1 x55_P1 )  (and (=  ( str.substr input2_P1_d2  0 (- 7 0) )  "1998-01"  )  (and (=  x58_P1 x65_P1 )  (and (isinteger  input1_P1_d22 )  (and (=  input3_P2_d12  "Shoes"  )  (and  (not (=  input3_P2_d12  "Electronics"  ))  (and  (not (=  input3_P2_d12  "Home"  ))  (and (=  x50_P2 x55_P2 )  (and (=  ( str.substr input2_P2_d2  0 (- 7 0) )  "1998-01"  )  (and (=  x58_P2 x65_P2 )  (and (isinteger  input1_P2_d22 )  (and (=  x73_P2 x73_P1 )  (and (=  ( select  x80 1 ) x76 )  (and (>=  1 0 )  (and (<  1 x77 )  (and (=  ( select  x80 0 ) x78 )  (and (>=  0 0 )  (and (<  0 x77 )  (and (>=  x77 0 ) (=  x27_P1 x73_P1 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
