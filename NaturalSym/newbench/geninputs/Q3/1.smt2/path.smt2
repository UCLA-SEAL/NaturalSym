...
(assert (= input1_P1 (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ input1_P1_d0 (str.++ "," input1_P1_d1)) (str.++ "," input1_P1_d2)) (str.++ "," input1_P1_d3)) (str.++ "," input1_P1_d4)) (str.++ "," input1_P1_d5)) (str.++ "," input1_P1_d6)) (str.++ "," input1_P1_d7)) (str.++ "," input1_P1_d8)) (str.++ "," input1_P1_d9)) (str.++ "," input1_P1_d10)) (str.++ "," input1_P1_d11)) (str.++ "," input1_P1_d12)) (str.++ "," input1_P1_d13)) (str.++ "," input1_P1_d14)) (str.++ "," input1_P1_d15)) (str.++ "," input1_P1_d16)) (str.++ "," input1_P1_d17)) (str.++ "," input1_P1_d18)) (str.++ "," input1_P1_d19)) (str.++ "," input1_P1_d20)) (str.++ "," input1_P1_d21)) (str.++ "," input1_P1_d22)))); splitHandler input1_P1 23
...
(assert (= input1_P2 (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ input1_P2_d0 (str.++ "," input1_P2_d1)) (str.++ "," input1_P2_d2)) (str.++ "," input1_P2_d3)) (str.++ "," input1_P2_d4)) (str.++ "," input1_P2_d5)) (str.++ "," input1_P2_d6)) (str.++ "," input1_P2_d7)) (str.++ "," input1_P2_d8)) (str.++ "," input1_P2_d9)) (str.++ "," input1_P2_d10)) (str.++ "," input1_P2_d11)) (str.++ "," input1_P2_d12)) (str.++ "," input1_P2_d13)) (str.++ "," input1_P2_d14)) (str.++ "," input1_P2_d15)) (str.++ "," input1_P2_d16)) (str.++ "," input1_P2_d17)) (str.++ "," input1_P2_d18)) (str.++ "," input1_P2_d19)) (str.++ "," input1_P2_d20)) (str.++ "," input1_P2_d21)) (str.++ "," input1_P2_d22)))); splitHandler input1_P2 23
(assert  (and (=  x24_P1 ( select  x30 0 ) )  (and (=  x24_P2 ( select  x30 1 ) )  (and (=  x3_P1 input2_P1_d0 )  (and (=  x6_P1 input1_P1_d22 )  (and (=  x9_P1 input1_P1_d1 )  (and (=  x16_P1 input3_P1_d0 )  (and (=  x20_P1 input2_P1_d6 )  (and (=  x22_P1 input3_P1_d8 )  (and (=  x23_P1 input3_P1_d7 )  (and (=  x24_P1 (+  ( str.to_int input1_P1_d13  ) (+  ( str.to_int input1_P1_d14  ) (+  ( str.to_int input1_P1_d12  ) ( str.to_int input1_P1_d21  ) ) ) ) )  (and (=  x3_P2 input2_P2_d0 )  (and (=  x6_P2 input1_P2_d22 )  (and (=  x9_P2 input1_P2_d1 )  (and (=  x16_P2 input3_P2_d0 )  (and (=  x20_P2 input2_P2_d6 )  (and (=  x22_P2 input3_P2_d8 )  (and (=  x23_P2 input3_P2_d7 )  (and (=  x24_P2 (+  ( str.to_int input1_P2_d13  ) (+  ( str.to_int input1_P2_d14  ) (+  ( str.to_int input1_P2_d12  ) ( str.to_int input1_P2_d21  ) ) ) ) ) (=  x29 (+  x26 x28 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(assert  (and (=  input2_P1_d8  "11"  )  (and (=  x3_P1 x6_P1 )  (and (=  input3_P1_d13  "1"  )  (and (=  x9_P1 x16_P1 )  (and (isinteger  input1_P1_d21 )  (and (isinteger  input1_P1_d13 )  (and (isinteger  input1_P1_d12 )  (and (isinteger  input1_P1_d14 )  (and (=  input2_P2_d8  "11"  )  (and (=  x3_P2 x6_P2 )  (and (=  input3_P2_d13  "1"  )  (and (=  x9_P2 x16_P2 )  (and (isinteger  input1_P2_d21 )  (and (isinteger  input1_P2_d13 )  (and (isinteger  input1_P2_d12 )  (and (isinteger  input1_P2_d14 )  (and (=  x20_P2 x20_P1 )  (and (=  x22_P2 x22_P1 )  (and (=  x23_P2 x23_P1 )  (and (=  ( select  x30 1 ) x26 )  (and (>=  1 0 )  (and (<  1 x27 )  (and (=  ( select  x30 0 ) x28 )  (and (>=  0 0 )  (and (<  0 x27 ) (>=  x27 0 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
