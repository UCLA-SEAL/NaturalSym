...
(assert  (and (=  x1 input3_d22 )  (and (=  x6 input4_d0 )  (and (=  x9 input3_d1 )  (and (=  x14 input5_d0 )  (and (=  x17 input3_d3 )  (and (=  x26 input1_d0 )  (and (=  x29 input3_d7 ) (=  x40 input2_d0 ) ) ) ) ) ) ) ) )
(assert  (and (=  input4_d6  "1999"  )  (and (=  x1 x6 )  (and (=  x9 x14 )  (and (=  input1_d3  "Primary"  )  (and (=  input1_d2  "M"  )  (and (=  input1_d1  "M"  )  (and (=  x17 x26 )  (and (=  input2_d14  "N"  )  (and (=  input2_d9  "N"  )  (not (=  x29 x40 )) ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
