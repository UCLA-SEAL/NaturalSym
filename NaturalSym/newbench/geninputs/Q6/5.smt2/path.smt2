...
(assert  (and (=  x1 input1_d0 )  (and (=  x4 input2_d4 )  (and (=  x7 input2_d0 )  (and (=  x12 input3_d2 )  (and (=  x15 input3_d22 )  (and (=  x22 input4_d0 )  (and (=  x25 input3_d1 ) (=  x34 input5_d0 ) ) ) ) ) ) ) ) )
(assert  (and (=  x1 x4 )  (and (=  x7 x12 )  (and (=  x15 x22 )  (not (=  x25 x34 )) ) ) ) )
(check-sat)
(get-model)
