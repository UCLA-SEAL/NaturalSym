...
(assert (= input1 (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ input1_d0 (str.++ "," input1_d1)) (str.++ "," input1_d2)) (str.++ "," input1_d3)) (str.++ "," input1_d4)) (str.++ "," input1_d5)) (str.++ "," input1_d6)) (str.++ "," input1_d7)) (str.++ "," input1_d8)) (str.++ "," input1_d9)) (str.++ "," input1_d10)) (str.++ "," input1_d11)) (str.++ "," input1_d12)))); splitHandler input1 13
(assert  (and (=  x1 input1_d0 )  (and (=  x4 input2_d4 )  (and (=  x7 input2_d0 )  (and (=  x12 input3_d2 )  (and (=  x15 input3_d22 )  (and (=  x22 input4_d0 )  (and (=  x25 input3_d1 )  (and (=  x34 input5_d0 )  (and (=  x37 input4_d3 ) (=  x50 input4_d3 ) ) ) ) ) ) ) ) ) ) )
(assert  (and (<=  ( str.to_int input5_d5  ) 100 )  (and (isinteger  input5_d5 )  (and (=  x1 x4 )  (and (=  x7 x12 )  (and (=  x15 x22 )  (and (=  x25 x34 )  (and (=  input4_d8  "2001"  )  (and (=  input4_d6  "1"  ) (=  x37 x50 ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
