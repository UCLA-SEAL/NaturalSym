...
(assert  (and (=  x1 input1_d0 )  (and (=  x2 input1_d1 )  (and (=  x8 input2_d0 )  (and (=  x9 ( str.to_int input2_d5  ) ) (=  x12 ( str.++ ( str.++ ( str.++  ""  x2 )  ","  ) ( str.from_int x9  ) ) ) ) ) ) ) )
(assert  (and (>  (-  ( str.to_int input2_d2  ) ( str.to_int input2_d3  ) ) 5000 )  (and (isinteger  input2_d3 )  (and (isinteger  input2_d2 )  (and (<  (-  ( str.to_int ( str.substr input2_d4  0 (- 4 0) )  ) ( str.to_int input2_d1  ) ) 10 )  (and (isinteger  input2_d1 )  (and (isinteger  ( str.substr input2_d4  0 (- 4 0) ) )  (and (isinteger  input2_d5 ) (=  x1 x8 ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
