...
(assert  (and (=  x1 ( str.++ ( str.++  ""  input1_d4 ) ( str.substr input1_d2  0 (- 2 0) ) ) ) (=  x2 (-  (+  (+  ( str.to_int ( str.substr input1_d3  3 (- 5 3) )  ) (*  ( str.to_int ( str.substr input1_d3  0 (- 2 0) )  ) 60 ) ) 1440 ) (+  ( str.to_int ( str.substr input1_d2  3 (- 5 3) )  ) (*  ( str.to_int ( str.substr input1_d2  0 (- 2 0) )  ) 60 ) ) ) ) ) )
