...
(assert  (and (=  x3 input1_d0 )  (and (=  x6 input2_d22 )  (and (=  x9 input2_d1 )  (and (=  x16 input3_d0 )  (and (=  x19 input2_d2 ) (=  x26 input4_d0 ) ) ) ) ) ) )
(assert  (and (=  input1_d6  "1999"  )  (and (=  input1_d8  "11"  )  (and (=  x3 x6 )  (and (=  input3_d20  "50"  )  (and (=  x9 x16 )  (not (=  x19 x26 )) ) ) ) ) ) )
(check-sat)
(get-model)
