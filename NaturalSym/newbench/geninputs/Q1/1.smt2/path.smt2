...
(assert  (and (=  x11_P1 ( select  x17 0 ) )  (and (=  x11_P2 ( select  x17 1 ) )  (and (=  x1_P1 input1_P1_d19 )  (and (=  x6_P1 input2_P1_d0 )  (and (=  x9_P1 input1_P1_d2 )  (and (=  x10_P1 input1_P1_d6 )  (and (=  x11_P1 ( str.to_int input1_P1_d10  ) )  (and (=  x1_P2 input1_P2_d19 )  (and (=  x6_P2 input2_P2_d0 )  (and (=  x9_P2 input1_P2_d2 )  (and (=  x10_P2 input1_P2_d6 )  (and (=  x11_P2 ( str.to_int input1_P2_d10  ) )  (and (=  x16 (+  x13 x15 ) )  (and (=  x25 input3_d0 )  (and (=  x32 input4_d0 ) (=  x37 input4_d1 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(assert  (and (=  input2_P1_d6  "1999"  )  (and (=  x1_P1 x6_P1 )  (and (isinteger  input1_P1_d10 )  (and (=  input2_P2_d6  "1999"  )  (and (=  x1_P2 x6_P2 )  (and (isinteger  input1_P2_d10 )  (and (=  x9_P2 x9_P1 )  (and (=  x10_P2 x10_P1 )  (and (=  ( select  x17 1 ) x13 )  (and (>=  1 0 )  (and (<  1 x14 )  (and (=  ( select  x17 0 ) x15 )  (and (>=  0 0 )  (and (<  0 x14 )  (and (>=  x14 0 )  (and (>  x16 10000 )  (and (=  x10_P1 x25 )  (and (=  x9_P1 x32 ) (=  input3_d24  "TN"  ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
