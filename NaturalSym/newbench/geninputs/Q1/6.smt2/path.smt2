...
(assert  (and (=  input2_P1_d6  "1999"  )  (and (=  x1_P1 x6_P1 )  (and (isinteger  input1_P1_d10 )  (and (=  input2_P2_d6  "1999"  )  (and (=  x1_P2 x6_P2 )  (and (isinteger  input1_P2_d10 )  (and (=  x9_P2 x9_P1 )  (and (=  x10_P2 x10_P1 )  (and (=  ( select  x17 1 ) x13 )  (and (>=  1 0 )  (and (<  1 x14 )  (and (=  ( select  x17 0 ) x15 )  (and (>=  0 0 )  (and (<  0 x14 )  (and (>=  x14 0 )  (and (>  x16 10000 )  (and (=  x10_P1 x25 )  (not (=  x9_P1 x32 )) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
