...
(assert  (and (=  x1 input1_d0 )  (and (=  x2 ( str.to_int input1_d1  ) )  (and (=  x4 input2_d0 ) (=  x5 ( str.to_int input2_d1  ) ) ) ) ) )
(assert  (and (isinteger  input1_d1 )  (and (isinteger  input2_d1 )  (not (=  x1 x4 )) ) ) )
(check-sat)
(get-model)
